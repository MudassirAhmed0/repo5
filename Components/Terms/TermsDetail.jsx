...
import TopBrand from '../../assets/images2/svg/brand-terms.svg'
    ...
    return (
        <>
            <div className={`${styles.bgColor} relative rounded-t-xl`}>
                ...
                <div className='pb-7 pt-10 px-20'>
                    <div className='w-10/12 pr-2.5'>
                        <span>
            ...
            <div>
                <div className={`w-2/12 h-2.5 ml-auto ${styles.yellowbg}`}></div>
                <div className='pt-5 px-20 pb-12'>
