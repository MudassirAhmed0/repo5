...
import call from '../../assets/images2/svg/call.svg'
import mail from '../../assets/images2/svg/mail.svg'
import location from '../../assets/images2/svg/location.svg'
...
const ContactDetail = () => {
    ...
    return (
        <div className='flex gap-x-28 pl-24 pr-8 py-20'>
            ...
            <div className={styles.getside}>
                ...
                <div className={`mt-7 relative  ${layoutStyles.newsletter} ${layoutStyles.track}  ${styles.newsletter} ${styles.track} `}>
                  ...
                  {messageError&&  <span className="text-red-500">This  field is Required.</span>}
                    ...
                    <button  onClick={handleSubmit} className='mt-12 w-36 h-10 flex justify-center rounded items-center border-2  border-yellow medium-font  hover:bg-yellow hover:text-grey'>
                        Submit
                    </button>
