...
import yelllowBox from '../../assets/images2/svg/box-yellow.svg'
import frame from '../../assets/images2/svg/developer-frame.svg'
import dot from '../../assets/images2/svg/developer-dot.svg'
    ...
    return (
        <div className={` ${styles.hDevelopers} relative`}>
            ...
            <div className={styles.topSection}>
                <div className='pt-12 px-20 pb-24 '>
                    <span className=' flex justify-center'>
                        <Image src={yelllowBox} alt="Yellow cube" />
                    </span>
                    <h2 className='text-3xl mt-4 medium-font text-grey text-center'>Simplified Shipping Manage for Streamlined <br /> <span className='text-blue'>Pre-</span> and <span className='text-blue'>Post-Sale</span> Processing</h2>
                    <p className={`text-center mt-8 text-lg text-grey light-font m-auto ${styles.w62}`}>The Zajil API offers streamlined integration to standard shopping cart applications such as Shopify and other ERP environments. Once connected, your site (or application) can create shipments to provide reference and tracking numbers, even specify COD at time of order. You can also manage post-order activities such as label printing, cancel shipments, or create pickup orders.</p>
                </div>
            </div>
            <div className='pt-12 px-20 pb-24 realtive'>
                <div className={`absolute flex justify-between ${styles.cards}`}>
                    <div className={`${styles.cardWidth} px-8 pr-7 pt-9  pb-8 relative`}>
                        <h2 className='text-4xl text-yellow absolute  -top-5 '>01</h2>
                        ...
                        <div className='flex gap-x-2 mt-1.5 items-start'>
                            <span className='w-5 img_container'>
                                <Image src={dot} alt="Dot" />
                            </span>
                    ...
                    <div className={`${styles.cardWidth} px-8 pr-7 pt-9  pb-8 relative`}>
                        <h2 className='text-4xl text-yellow absolute  -top-5 '>02</h2>
                    ...
                    <div className={`${styles.cardWidth} px-8 pr-7 pt-9  pb-8 relative`}>
                        <h2 className='text-4xl text-yellow absolute  -top-5 '>03</h2>
